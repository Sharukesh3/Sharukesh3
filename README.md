...
[![programming languages](https://skillicons.dev/icons?i=python,java,c,javascript,matlab,scala,bash,powershell,html,css)](https://skillicons.dev)
![Assembly](https://img.shields.io/badge/Assembly-654FF0?style=for-the-badge&logo=assemblyscript&logoColor=white)

### AI/ML & Data Science
[![python ai libs](https://skillicons.dev/icons?i=tensorflow,pytorch,sklearn,opencv,anaconda)](https://skillicons.dev)
...
### Databases
[![Databases](https://skillicons.dev/icons?i=postgres,mysql,mongo,redis,sqlite,firebase,supabase)](https://skillicons.dev)

### Web Development & backend
[![SDE](https://skillicons.dev/icons?i=react,django,flask,fastapi,tailwind,bootstrap)](https://skillicons.dev)
![REST API](https://img.shields.io/badge/REST_API-02569B?style=for-the-badge&logo=rest&logoColor=white)

### Devops
[![devops](https://skillicons.dev/icons?i=docker,kubernetes,githubactions,prometheus,grafana,nginx)](https://skillicons.dev)

### Cloud
[![cloud](https://skillicons.dev/icons?i=aws,azure,gcp,cloudflare)](https://skillicons.dev)
...
|---------|------------|-------------|
| **DDoS Prediction** | Neural Networks | Predictive model for network security |
| **Maze Solver** | Reinforcement Learning | AI agent for pathfinding optimization |
| **Automated Report Writing** | Computer Vision | Threat detection and documentation |
| **Text Compression** | Algorithms | Huffman, LZ77, LZW implementations |
| **Database Indexing** | Data Structures | B+ tree implementation |
| **Smart Home Energy** | IoT | Energy management system |
| **Autonomous Delivery Robot** | Robotics | Last-mile delivery solution |
| **Robotic Arm & Dog** | Robotics Control | Remote-controlled systems |
...
*Amrita School of AI, Amrita Vishwa Vidyapeetham* | **CGPA: 8.78**
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=00d4ff&height=120&section=footer" alt="Footer" />
</div>

<div align="center">
  <i>⭐ "Building AI systems that make a difference" ⭐</i>
</div>
